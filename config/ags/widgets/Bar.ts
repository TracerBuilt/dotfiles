...
const date = Variable("", {
	poll: [1000, `date "+%_I:%M %B, %e"${nthNumber(new Date().getDate())}`],
})
...
const bluetooth_connected_list = Widget.Box({
...
const Bluetooth_Indicator = () => Widget.Button({
	child: bluetooth_icon,
	onClicked: () => bluetooth_connected_list
})
